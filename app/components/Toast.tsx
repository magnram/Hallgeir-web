...
export default function Toast({ type, message, onClose, autoCloseDuration }: ToastProps) {
	...
	const icon = type === ToastType.Success ? successIcon : type === ToastType.Warning ? warningIcon : errorIcon;
	const color = type === ToastType.Success ? "green" : type === ToastType.Warning ? "yellow" : "red";
	const closeIcon = (
